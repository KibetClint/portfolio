  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      <div
        ...
        <div className="w-72 rounded-2xl overflow-hidden shadow-2xl shadow-green-500/20 border border-border/50">
          {/* Header — button pinned to the right */}
          <div className="bg-gradient-to-r from-green-600 to-green-500 p-4 flex items-center justify-end">
            <button
          ...
          <div className="bg-card p-4">
            <div className="bg-muted rounded-xl rounded-tl-sm p-3 mb-4 min-h-[72px]">
            ...
            <a
              ...
              className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-green-500 hover:bg-green-600 text-white font-semibold text-sm transition-all hover:scale-[1.02] active:scale-[0.98]">
      ...
      <button
        ...
        className={`group relative w-14 h-14 rounded-full bg-green-500 hover:bg-green-600 text-white flex items-center justify-center shadow-lg shadow-green-500/30 transition-all duration-300 hover:scale-110 active:scale-95 ${
